# UVVision Training
#python main.py --model EDSR --scale 1 --patch_size 96 --n_feats 256 --res_scale 0.1 --epochs 100 --ext sep --save UVVision_zy --reset
#python main.py --model EDSR --scale 1 --patch_size 96 --n_feats 64 --res_scale 0.8 --epochs 100 --ext sep --lr 1e-4 --lr_decay 40 --pre_train ../experiment/UVVision_zy/model/model_best.pt --save UVVision_zy
# UVVision Testing 
#python main.py --data_test Demo --scale 1 --patch_size 96 --n_feats 256 --res_scale 0.1 --pre_train ../experiment/UVVision_zy/model/model_best.pt --test_only --save_results
#python main.py --data_test Demo --scale 1 --patch_size 96 --n_feats 64 --res_scale 0.8 --pre_train ../experiment/UVVision_zy/model/model_best.pt --test_only --save_results



# GUN resnet versionn training
#python main.py --model GUNRES --scale 2 --patch_size 96 --n_resblocks 64 --n_feats 128 --res_scale 0.1 --epochs 200 --ext sep --lr 1e-4 --lr_decay 40 --save GUNRES_x2 --reset

#continue training
python main.py --model GUNRES --scale 2 --patch_size 96 --n_resblocks 64 --n_feats 128 --res_scale 0.1 --epochs 300 --ext sep --lr 1e-4 --lr_decay 40 --pre_train ../experiment/GUNRES_x2/model/model_best.pt --save GUNRES_x2 

# GUN TEST on Set5
#python main.py --data_test Set14 --scale 2 --model GUNRES --pre_train ../experiment/GUNRES_x2/model/model_best.pt --test_only --save_results

#python main.py --data_test Demo --scale 2 --patch_size 96 --n_feats 64 --res_scale 1  --pre_train ../experiment/GUNRES_x2/model/model_best.pt --test_only --save_results
...
#python main.py --model EDSR --scale 2 --save EDSR_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --n_threads 0 --reset
...
#python main.py --data_test Set5 --scale 2 --pre_train ../experiment/EDSR_baseline_x2_zy/model/model_best.pt --test_only --self_ensemble
...
#python main.py --data_test Demo --scale 2 --pre_train ../experiment/EDSR_baseline_x2_zy/model/model_best.pt --test_only --save_results
...
# RDN BI model (x4)
#python3.6 main.py --scale 4 --save RDN_D16C8G64_BIx4 --model RDN --epoch s 200 --batch_size 16 --data_range 801-805 --patch_size 128 --reset
